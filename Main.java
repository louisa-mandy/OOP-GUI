...
/*
label : input register, login, check balance, membership, pay ticket
btn : input register, login, check balance, membership, pay ticket

register : email, password, sama name -> btn register clicked -> masukkan ke json untuk account nya(email, pw) 
login : tarik data dari json yang register , buat ke login -> when btn login clicked if email & pw matched, masuk ke page Main, 

switch case (kamu make sure harus pake label, pake textboxt dll) : 
1. page check balance
2. page lain
